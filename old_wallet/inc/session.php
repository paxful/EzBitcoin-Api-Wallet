...
//#
function funct_GetUserIDfromUserCode()
{ //legacy function to switch over to user code hash instead of easily spoofed id
    ...
    if ($strCookieUserIDlegacy) {
        $query = "SELECT * FROM " . TBL_USERS . " WHERE id= " . $strCookieUserIDlegacy . " ";
    }
    if ($strUserIDcode) {
...
function functConfirmUserPass_hash($email, $password)
{ //this ver
