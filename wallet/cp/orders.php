...
<p></p>
        ...
        <a href="orders.php?f=filledorderscheck&sort=<?=$sortby?>"><strong>Filled Check</strong></a> --- 
        <a href="orders.php?f=allchecks&sort=<?=$sortby?>"><strong>Checks w Deposits</strong></a> --- 
        ...
        <a href="orders.php?f=check&sort=<?=$sortby?>">Check</a>
