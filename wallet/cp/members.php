...
<?php include __ROOT__.PATH_ADMIN."hud.php"; ?>
    ...
    <div class="row">
    	<h5>Filter: 
        <a href="members.php?f=all&sort=<?=$sortby?>">All Users</a> --- 
        <a href="members.php?f=verified&sort=<?=$sortby?>">Verified Email</a> --- 
        <a href="members.php?f=withbalance&sort=<?=$sortby?>">With Balance>0</a> --- 
        <a href="members.php?f=withsends&sort=<?=$sortby?>">With External Sends</a>
        <br>Sort:         
        <a href="members.php?sort=datenew&f=<?=$strFilter?>">Date New</a> / <a href="members.php?sort=dateold&filter=<?=$strFilter?>">Old</a> --- 
        <a href="members.php?sort=balancehigh2low&f=<?=$strFilter?>">Balance High</a> / <a href="members.php?sort=balancelow2high&filter=<?=$strFilter?>">Low</a> ---
        <a href="members.php?sort=namea&f=<?=$strFilter?>">Name A</a> / <a href="members.php?sort=namez&filter=<?=$strFilter?>">Name Z</a>
    	</h5>
    </div>
...
<!-- Replace all this code with loadcontent.php module call -->
	 <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0">
        ...
        <tr>
			...
			<td align="left"><h4>Upload</h4></td>
			<td align="left"><h4>Name</h4></td>
          	<td align="left"><h4>Contact</h4></td>
          	<td align="left"><h4>Balance</h4></td>
          	<td align="left"><h4>Joined</h4></td>
        </tr>
  		</thead>
		<tbody id="tabledata">
		<?php 
			...
			$strDo= "include";
			//$intType = "members"; //files - get from top
			//$intLastMSGID = 0; 
			//$intMaxRecords = 100 ;//get from top
			$intRecID = false;
