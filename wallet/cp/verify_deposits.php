...
<p></p>
    	...
    	<h5>Filter: 
        <a href="?f=all&sort=<?=$sortby?>">All Banks</a> --- 
        ...
        <?php                       
	        ...
	        {
	            $intBankID_DB=		$row["bank_id"];
	            $strBankName=		$row["bank_name"];
	             
	    ?>
	        <a href="?f=<?=$intBankID_DB?>&sort=<?=$sortby?>"><? if($strFilter==$intBankID_DB){ echo " <strong> $strBankName </strong> " ; }else{ echo $strBankName; } ?></a> --- 

	    <?php } //End Record While Loop ?>
        
        <br>Sort:         
        <a href="?sort=datenew&f=<?=$strFilter?>">Date New</a> / <a href="?sort=dateold&f=<?=$strFilter?>">Old</a> --- 
        <a href="?sort=amthigh2low&f=<?=$strFilter?>">Amt High</a> / <a href="?sort=amtlow2high&f=<?=$strFilter?>">Low</a> ---
        <a href="?sort=namea&f=<?=$strFilter?>">Name A</a> / <a href="?sort=namez&f=<?=$strFilter?>">Name Z</a>
    	</h5>
...
<!-- Replace all this code with loadcontent.php module call -->
	 <table width="100%" border="0" align="left" cellpadding="3" cellspacing="0">
		<thead>
	        <tr>
				<td align="left" width=""><strong>Deposit Date</strong></td>
				
				<td align="left" width=""><strong>Status</strong></td>
				<td align="left" width=""><strong>OrderID</strong></td>
...
<!-- 				<td align="left" width=""><strong>Order Date (ET) /<br>Upload Date</strong></td> -->
				...
				<td align="left" width="" style="width:150px"><strong>To Deposit</strong></td>
				<td align="left" width=""><strong>User Despoited</strong></td>
...
<!-- 	          	<td align="left" width=""><strong>Hash DateTime (UTC) /<br># Confirms</strong></td> -->
		...
		<?php 
			...
			$strDo= "include";
			$intType = "verify_deposits"; //files - get from top
			//$intLastMSGID = 0; 
			//$intMaxRecords = 100 ;//get from top
			$intRecID = false;
