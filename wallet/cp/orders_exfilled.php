...
<p></p>
    	...
    	<h5>Filter: 
        <a href="orders.php?f=all&sort=<?=$sortby?>">All Orders</a> --- 
        
        <a href="orders.php?f=receipt&sort=<?=$sortby?>"><strong>Receipt Provided</strong></a> --- 
        <a href="orders.php?f=openorders&sort=<?=$sortby?>"><strong>Open Orders</strong></a> --- 
        <a href="orders.php?f=filledorders&sort=<?=$sortby?>"><strong>Filled Orders</strong></a> --- 

        <a href="orders.php?f=cash&sort=<?=$sortby?>">Cash</a> --- 
        <a href="orders.php?f=bofa&sort=<?=$sortby?>">BofA</a> --- 
        <a href="orders.php?f=capitalone&sort=<?=$sortby?>">Capital One</a> --- 
        <a href="orders.php?f=chase&sort=<?=$sortby?>">Chase</a> --- 
        <a href="orders.php?f=wire&sort=<?=$sortby?>">Wire</a> --- 
        <a href="orders.php?f=inperson&sort=<?=$sortby?>">In Person</a>

        <br>Sort:         
        <a href="orders.php?sort=datenew&f=<?=$strFilter?>">Date New</a> / <a href="orders..php?sort=dateold&filter=<?=$strFilter?>">Old</a> --- 
        <a href="orders.php?sort=amthigh2low&f=<?=$strFilter?>">Amt High</a> / <a href="orders.php?sort=amtlow2high&filter=<?=$strFilter?>">Low</a> ---
        <a href="orders.php?sort=namea&f=<?=$strFilter?>">Name A</a> / <a href="orders.php?sort=namez&filter=<?=$strFilter?>">Name Z</a>
    	</h5>
...
<!-- 				<td align="left" width="" style="width:150px"><strong>Order Date</strong></td> -->
<!-- 				<td align="left" width=""><strong>Customer</strong></td> -->
				<td align="left" width=""><strong>Ordered</strong></td>
				<td align="left" width=""><strong>Customer</strong></td>
<!-- 				<td align="left" width=""><strong>Convert</strong></td> -->
				<td align="left" width=""><strong>Method</strong></td>
				<td align="left" width=""><strong>Order</strong></td>
	          	<td align="left" width=""><strong>Fill Date</strong></td>
	          	<td align="left" width=""><strong>Exchange</strong></td>
	          	<td align="left" width=""><strong>Fill Amt</strong></td>
	          	<td align="left" width=""><strong>Profit $</strong></td>
	          	<td align="left" width=""><strong>Profit B</strong></td>
...
<!-- 	          	<td align="left" width=""><strong>Est. BTC /<br>Est. Rate</strong></td> -->
...
<!-- 	          	<td align="left" width=""><strong>Hash DateTime (UTC) /<br># Confirms</strong></td> -->
		...
		<?php 
			...
			$strDo= "include";
			$intType = "orders_exfilled"; //files - get from top
			//$intLastMSGID = 0; 
			//$intMaxRecords = 100 ;//get from top
			$intRecID = false;
