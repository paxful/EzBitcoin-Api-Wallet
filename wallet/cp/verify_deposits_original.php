...
$intType = "verify_deposits_original"; //IMPORTANT - THIS IS THE SWITCH THAT IS USED IN LOADCONTENT.PHP  -John
...
<!-- 				<td align="left" width=""><strong>Deposit Method</strong></td> -->
				
				
<!-- 				<td align="left" width=""><strong>Order Date (ET) /<br>Upload Date</strong></td> -->
	          	<td align="left" width=""><strong>Type</strong></td>
	          	<td align="left" width=""><strong>To Deposit</strong></td>
				<td align="left" width="" style="width:150px"><strong>Deposited</strong></td>
...
<!-- 	          	<td align="left" width=""><strong>Hash DateTime (UTC) /<br># Confirms</strong></td> -->
		...
		<?php 
			...
			$strDo= "include";
			$intType = "verify_deposits_original"; //files - get from top
			//$intLastMSGID = 0; 
			//$intMaxRecords = 100 ;//get from top
			$intRecID = false;
