...
$config['database']['user_acc']['columns']['group_id'] = 'user_group_id';
...
$config['database']['user_group']['join'] = 'user_groups.id';
...
$config['database']['user_privilege_users']['columns']['user_id'] = 'user_account_id';
$config['database']['user_privilege_users']['columns']['privilege_id'] = 'user_privilege_id';
...
$config['database']['user_privilege_groups']['columns']['group_id'] = 'user_group_id';
$config['database']['user_privilege_groups']['columns']['privilege_id'] = 'user_privilege_id';
...
$config['database']['user_sess']['join'] = 'user_login_sessions.user_account_id';
$config['database']['user_sess']['columns']['user_id'] = 'user_account_id';
 ...
 */
$config['database']['settings']['identity_cols'] = array('email');
 ...
 */
$config['security']['user_cookie_expire'] = 9999999; // 116 days, almost unlimited
 ...
 */
$config['security']['static_salt'] = '12asd54sd5d0d993hfs63sja';
...
$config['email']['site_title'] = "Ez wallet";
